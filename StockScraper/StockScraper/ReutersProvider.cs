...
namespace StockScraper
{
    public class ReutersProvider
    {
        public static void StartImport(int job_id, ws_Stocks stock)
        {
            ...
            try
            {
                List<reuters_Financials_SalesEstimates> lst_reuters_Financials_SalesEstimate = reuters_Financials_SalesEstimatesProvider.GetData(doc1, job_id, stock.Stock_Id, analyticUrl);
            ...
            try
            {
                List<reuters_Financials_ValuationRatios> lst_reuters_Financials_ValuationRatios = reuters_Financials_ValuationRatiosProvider.GetData(doc2, job_id, stock.Stock_Id, financialHighlightsUrl);
            ...
            try
            {
                List<reuters_Financials_Dividends> lst_reuters_Financials_Dividends = reuters_Financials_DividendsProvider.GetData(doc2, job_id, stock.Stock_Id, financialHighlightsUrl);
            ...
            try
            {
                List<reuters_Financials_GrowthRates> lst_reuters_Financials_GrowthRates = reuters_Financials_GrowthRatesProvider.GetData(doc2, job_id, stock.Stock_Id, financialHighlightsUrl);
            ...
            try
            {
                List<reuters_Financials_Strength> lst_reuters_Financials_Strength = reuters_Financials_StrengthProvider.GetData(doc2, job_id, stock.Stock_Id, financialHighlightsUrl);
            ...
            try
            {
                List<reuters_Financials_ProfitabilityRatios> lst_reuters_Financials_ProfitabilityRatios = reuters_Financials_ProfitabilityRatiosProvider.GetData(doc2, job_id, stock.Stock_Id, financialHighlightsUrl);
            ...
            try
            {
                List<reuters_Financials_Efficiencies> lst_reuters_Financials_Efficiencies = reuters_Financials_EfficienciesProvider.GetData(doc2, job_id, stock.Stock_Id, financialHighlightsUrl);
            ...
            try
            {
                List<reuters_Financials_MgmtEffectiveness> lst_reuters_Financials_MgmtEffectiveness = reuters_Financials_MgmtEffectivenessProvider.GetData(doc2, job_id, stock.Stock_Id,financialHighlightsUrl);
            ...
            try
            {
                List<reuters_Financials_Institutions> lst_reuters_Financials_Institutions = reuters_Financials_InstitutionsProvider.GetData(doc2,job_id,stock.Stock_Id,financialHighlightsUrl);
